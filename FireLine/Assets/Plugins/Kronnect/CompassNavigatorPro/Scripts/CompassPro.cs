...
namespace CompassNavigatorPro {
    ...
    public enum CompassStyle {
        ...
        SciFi6 = 27,
        Clean = 28,
        CleanWithIntegratedDegrees = 29,
        CleanWithIntegratedDegreesAndTicks1 = 30,
        CleanWithIntegratedDegreesAndTicks2 = 31,
        CleanWithIntegratedDegreesAndTicks3 = 32,
        CleanWithIntegratedDegreesAndTicks4 = 33,
        Custom = 99
    }

    public static class CompassStyleExtensions {
        public static bool HasDegreesOrTicks (this CompassStyle style) { return (int)style >= (int)CompassStyle.CleanWithIntegratedDegrees && (int)style <= (int)CompassStyle.CleanWithIntegratedDegreesAndTicks4; }
    }
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        public static GameObject Create () {
            GameObject compass = Resources.Load("CNPro/Prefabs/CompassNavigatorPro") as GameObject;
            if (compass != null) {
                compass = Instantiate(compass);
                compass.name = "CompassNavigatorPro";
                return compass;
            }
            return null;
        }
        ...
        [SerializeField]
        bool _hideIfNoCamera;

        /// <summary>
        /// Show/Hide compass, minimap and other elements if no valid cameras are visible
        /// </summary>
        public bool hideIfNoCamera {
            get { return _hideIfNoCamera; }
            set {
        ...
        [SerializeField]
        bool _compassBackSpriteScrollable;

        /// <summary>
        /// If the sprite can scroll horizontally
        /// </summary>
        public bool compassBackSpriteScrollable {
            get { return _compassBackSpriteScrollable; }
            set {
        ...
        [SerializeField]
        [Range(-1, 1)]
        float _compassBackSpriteScrollOffset;

        /// <summary>
        /// Offset to the sprite scroll
        /// </summary>
        public float compassBackSpriteScrollOffset {
            get { return _compassBackSpriteScrollOffset; }
            set {
        ...
        [SerializeField]
        float _onScreenIndicatorFarDistance = 10000f;

        /// <summary>
        /// Distance at which the on-screen indicator will not be visible
        /// </summary>
        public float onScreenIndicatorFarDistance {
            get { return _onScreenIndicatorFarDistance; }
            set {
        ...
        [SerializeField]
        Rect _offScreenIndicatorRect = new Rect(0, 0, 1, 1);

        /// <summary>
        /// Screen rect where indicators are displayed
        /// </summary>
        public Rect offScreenIndicatorRect {
            get { return _offScreenIndicatorRect; }
            set {
