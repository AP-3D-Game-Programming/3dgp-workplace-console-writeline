...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        void UpdateIndicators() {
            ...
            float vextentsX = (0.5f - _offScreenIndicatorMargin) * offScreenIndicatorRectWidth;
            float vextentsY = (0.5f - _offScreenIndicatorMargin * aspect) * offScreenIndicatorRectHeight;
            float minX = _offScreenIndicatorRect.xMin + _offScreenIndicatorMargin;
            float maxX = _offScreenIndicatorRect.xMax - _offScreenIndicatorMargin;
            float minY = _offScreenIndicatorRect.yMin + _offScreenIndicatorMargin * aspect;
            float maxY = _offScreenIndicatorRect.yMax - _offScreenIndicatorMargin * aspect;
            ...
            if (needUpdateIndicators) {
                ...
                for (int k = 0; k < poiCount; k++) {
                    ...
                    poi.lastIndicatorViewportPos.x = -1f;
                }
            }
            ...
            for (int k = 0; k < poiCount; k++) {
                ...
                if (poi.distanceToFollow > maxVisibleDistance) {
                    poi.ToggleIndicatorVisibility(false);
                    continue;
                }
                ...
                if (isOnScreen) {
                    ...
                    if (visible) {
                        ...
                        if (poi.offScreenIndicatorMarginOverride != 0) {
                            extentsX = (0.5f - poi.offScreenIndicatorMarginOverride) * offScreenIndicatorRectWidth;
                            extentsY = (0.5f - poi.offScreenIndicatorMarginOverride * aspect) * offScreenIndicatorRectHeight;
                        } else {
                            extentsX = vextentsX;
                            extentsY = vextentsY;
                        }
