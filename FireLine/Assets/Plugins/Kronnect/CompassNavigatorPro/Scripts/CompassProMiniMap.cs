...
namespace CompassNavigatorPro {
    ...
    public partial class CompassPro : MonoBehaviour {
        ...
        /// <summary>
        /// Allows rotation of the UI texture
        /// </summary>
        ...
        [SerializeField]
        bool _miniMapAutoResetDrag;

        /// <summary>
        /// Reset drag offset when user ends dragging
        /// </summary>
        public bool miniMapAutoResetDrag {
            get { return _miniMapAutoResetDrag; }
            set {
        ...
        [SerializeField]
        bool _miniMapFullScreenAutoResetDrag;

        /// <summary>
        /// Reset drag offset when user ends dragging in full screen mode
        /// </summary>
        public bool miniMapFullScreenAutoResetDrag {
            get { return _miniMapFullScreenAutoResetDrag; }
            set {
        ...
        float _miniMapFullScreenDragMaxDistance = 1000f;

        /// <summary>
        /// Maximum allowed drag in full screen mode
        /// </summary>
        public float miniMapFullScreenDragMaxDistance {
            get { return _miniMapFullScreenDragMaxDistance; }
            set {
        ...
        [SerializeField]
        MiniMapRadarGraphicsMethod _miniMapRadarGraphicsMethod = MiniMapRadarGraphicsMethod.ProceduralRings;

        public MiniMapRadarGraphicsMethod miniMapRadarGraphicsMethod {
            get { return _miniMapRadarGraphicsMethod; }
            set {
        ...
        [SerializeField]
        bool _miniMapRadarFadePOIs = true;

        /// <summary>
        /// Fade POI icons on radar when they approach radar border
        /// </summary>
        public bool miniMapRadarFadePOIs {
            get { return _miniMapRadarFadePOIs; }
            set {
        ...
        public void MiniMapZoomIn(float speed = 1f) {
            ...
            if (miniMapFullScreenState) {
                miniMapFullScreenZoomLevel += amount * _miniMapFullScreenZoomLevel;
            } else {
                miniMapZoomLevel += amount * _miniMapZoomLevel;
            }
        }
