...
namespace CompassNavigatorPro {
    ...
    public class CompassNavigatorProInspector : Editor {
        ...
        SerializedProperty cameraMain, follow, hideIfNoCamera;
        ...
        SerializedProperty showOnScreenIndicators, onScreenIndicatorPrefab, onScreenIndicatorScale, onScreenIndicatorNearFadeDistance, onScreenIndicatorNearFadeMin, onScreenIndicatorFarDistance, onScreenIndicatorAlpha, onScreenIndicatorShowDistance, onScreenIndicatorShowDistanceFormat, onScreenIndicatorShowTitle;

        SerializedProperty showOffScreenIndicators, offScreenIndicatorScale, offScreenIndicatorMargin, offScreenIndicatorRect, offScreenIndicatorAlpha, offScreenIndicatorAvoidOverlap, offScreenIndicatorOverlapDistance;
