...
namespace CompassNavigatorPro {
    ...
    public class CompassProPOIInspector : Editor {
        ...
        SerializedProperty showOnScreenIndicator, onScreenIndicatorScale, onScreenIndicatorShowDistance, onScreenIndicatorShowTitle, onScreenIndicatorNearFadeDistance, onScreenIndicatorNearFadeMin, onScreenIndicatorFarDistance;
        SerializedProperty showOffScreenIndicator, offScreenIndicatorMarginOverride;
